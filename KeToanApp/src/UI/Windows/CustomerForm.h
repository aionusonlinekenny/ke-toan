...
namespace KeToanApp {
    ...
    class CustomerForm {
    public:
        explicit CustomerForm(HWND parent);
        ~CustomerForm();
        ...
        // Prevent copying
        CustomerForm(const CustomerForm&) = delete;
        CustomerForm& operator=(const CustomerForm&) = delete;
    ...
    private:
        ...
        void LoadCustomers();
        void AddCustomerToList(int index, const std::wstring& code, const std::wstring& name,
