...
namespace KeToanApp {
    ...
    /**
     * Form quản lý danh mục kho
     */
    class WarehouseForm {
    public:
        explicit WarehouseForm(HWND parent);
        ~WarehouseForm();
        ...
        // Prevent copying
        WarehouseForm(const WarehouseForm&) = delete;
        WarehouseForm& operator=(const WarehouseForm&) = delete;
    ...
    private:
        ...
        void LoadWarehouses();
        void AddWarehouseToList(int index, const std::wstring& code, const std::wstring& name,
